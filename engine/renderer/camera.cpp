...
static const float maxVerticalAngle = 85.0f;  // has to be less than 90 to avoid gimbal lock.
...
glm::mat4 Camera::orientation() const {
  ...
  /* glm::rotate takes (matrix, angle, axis_vector). */
...
void Camera::normalizeAngles() {
  /* modulo 360 is taken of horizontalAngle */
